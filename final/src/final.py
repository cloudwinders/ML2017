...
# Read data
macro = pd.read_csv(os.path.join(sys.argv[1],'macro.csv'))
...
#load files
train = pd.read_csv(os.path.join(sys.argv[1],'train.csv'), parse_dates=['timestamp'])
test = pd.read_csv(os.path.join(sys.argv[1],'test.csv'), parse_dates=['timestamp'])
macro = pd.read_csv(os.path.join(sys.argv[1],'macro.csv'), parse_dates=['timestamp'])
id_test = test.id
...
#x_train.to_csv("D:/Drive/MachineLearning/final/v11/jason_x_train.csv",index=False)
#x_test.to_csv("D:/Drive/MachineLearning/final/v11/jason_x_test.csv",index=False)
...
#jason_model_output.to_csv('D:/Drive/MachineLearning/final/v11/jason_model.csv', index=False)
...
#plot_tree(model)
#plt.show()
#plt.savefig('D:/Drive/MachineLearning/final/v11/jason_model_fig.png',format='png',dpi=1000)
...
#x_train.to_csv("D:/Drive/MachineLearning/final/v11/Reynaldo_x_train.csv",index=False)
#x_test.to_csv("D:/Drive/MachineLearning/final/v11/Reynaldo_x_test.csv",index=False)
...
#reynaldo_model_output.to_csv('D:/Drive/MachineLearning/final/v11/reynaldo_model.csv', index=False)
...
#plot_tree(model)
#plt.show()
#plt.savefig('D:/Drive/MachineLearning/final/v11/Reynaldo_model_fig.png',dip=1000)
...
df_train = pd.read_csv(os.path.join(sys.argv[1],'train.csv'), parse_dates=['timestamp'])
df_test = pd.read_csv(os.path.join(sys.argv[1],'test.csv'), parse_dates=['timestamp'])
df_macro = pd.read_csv(os.path.join(sys.argv[1],'macro.csv'), parse_dates=['timestamp'])
...
#X_train.to_csv("D:/Drive/MachineLearning/final/v11/Bruno_x_train.csv",index=False)
#X_test.to_csv("D:/Drive/MachineLearning/final/v11/Bruno_x_test.csv",index=False)
...
#bruno_model_output.to_csv('D:/Drive/MachineLearning/final/v11/bruno_model.csv', index=False)
...
#results.to_csv('D:/Drive/MachineLearning/final/v11/unadjusted_combo.csv', index=False)
...
sub.to_csv(os.path.join(sys.argv[2],'sub.csv'), index=False)
